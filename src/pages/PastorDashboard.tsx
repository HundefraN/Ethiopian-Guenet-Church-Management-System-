      ...
      <motion.div variants={containerVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        {[
          ...
          <motion.div key={i} variants={itemVariants}
            className="group bg-white rounded-[1.5rem] p-6 border border-gray-100/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_40px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
            <div className="absolute -top-8 -right-8 opacity-[0.03] group-hover:opacity-[0.07] transition-all duration-500">
              <card.icon size={120} />
            </div>
      ...
      <motion.div variants={containerVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <motion.div variants={itemVariants} className="bg-white rounded-[1.5rem] border border-gray-100/80 shadow-[0_4px_24px_rgba(0,0,0,0.04)] overflow-hidden flex flex-col">
          ...
          <div className="p-6 md:p-8 flex-1 space-y-7">
            ...
            <div className="bg-gradient-to-br from-[#0f172a] to-[#1e3a5f] rounded-2xl p-5 text-center relative overflow-hidden">
